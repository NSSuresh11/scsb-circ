...
public class LookupUser extends ScsbNCIP {
    ...
    public LookupUserInitiationData getLookupUserInitiationData(String useridString, String fromNcipAgencyId, String ncipAgencyId) {
        LookupUserInitiationData lookupUserInitationData = new LookupUserInitiationData();
        InitiationHeader initiationHeader = new InitiationHeader();
        initiationHeader = getInitiationHeaderwithoutScheme(initiationHeader, fromNcipAgencyId, ncipAgencyId);
