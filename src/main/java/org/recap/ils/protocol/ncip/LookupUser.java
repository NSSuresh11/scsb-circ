...
public class LookupUser extends ScsbNCIP {
    ...
    public LookupUserInitiationData getLookupUserInitiationData(String profileType, String useridString, String ncipAgencyId) {
        LookupUserInitiationData lookupUserInitationData = new LookupUserInitiationData();
        InitiationHeader initiationHeader = new InitiationHeader();
        initiationHeader = getInitiationHeaderwithoutScheme(initiationHeader, profileType, ncipAgencyId, ncipAgencyId);
